...
ros2 run robot_state_publisher robot_state_publisher \
  ...
  source /opt/ros/jazzy/setup.bash && source ~/ros2_ws/install/setup.bash && ros2 run robot_state_publisher robot_state_publisher --ros-args -p robot_description:="$(cat ~/ros2_ws/src/robot_description/urdf/simple_robot.urdf)"
